while True:
    ...
    s=0
    s1=0
    s=sum(df.number_of_goals_team1)#Adds all goals team a scored as home team
    s1=sum(df1.number_of_goals_team2)#Adds all goals team a scored as away team
    s+=s1
    ...
    def win(lgw):
          ...
          for i in l1:
              ...
              for j in m_id:
                  temp_df=dff[dff.Match_No==j]#In match x,how many goals team 1 scored
                  temp_df1=dff1[dff1.Match_No==j]#In match x,how many goals team 2 scored
    ...
    def points(l):
        ...
        return(l)
#Graph
    a1=input("Do you want to see a graphical representation of Goals scored by all teams?(Enter yes or no)\n")
    b1=a1.lower()
    if b1=="yes":
        ...
        pass
    e=input("Do you want to proceed?(Enter yes or no)\n")
    e=e.lower()
    if e=="yes":
        ...
        for i in range(len(w1)):
            w1[i]=w1[i]+[l1[i]]+[list1[i]]+[list2[i]]+[list1[i]-list2[i]]
                ...
                if w1[j][3]==w1[j+1][3]:
                    if w1[j][7]<w1[j+1][7]:
                        ...
                        if w1[j][5]<w1[j+1][5]:
                           ...
                           w1[j]=w1[j+1]
                           w1[j+1]=t 
        myTable=PrettyTable(["Position","Team","Wins","Draws","Losses","Points","Goals scored","Goals conceded","Goal Difference"])
        c=1
        for i in w1:
        ...
        break
    e1=input("Do you want to proceed(Enter yes or no)?\n")
    e1=e1.lower()
    if e1=="yes":
        from tkinter import *
...
#Label
        ...
        def name(*args):
            ...
            ls.configure(text="Goals: {}\nAssists: {}\nTotal shots: {}\nShots on target: {}\nTackles: {}\nTackles won: {}".format(g,f,h,l,y,z))
        st.trace("w", name)
        def name1(*args):
            m1=st1.get()
            ...
            ls1.configure(text="Goals: {}\nAssists: {}\nTotal shots: {}\nShots on target: {}\nTackles: {}\nTackles won: {}".format(g1,f1,h1,l1,y1,z1))
        st1.trace("w", name1)
        tk.mainloop()
    else:
        break
    ...
    if e1=="yes":
        ...
        aa=input('Enter a team name to see how many yellow and red cards they got during the world cup\n').title()
        while aa not in l1:
        ...
        break
    e1=input("Do you want to see our case study(Enter yes or no)?\n")
    e1=e1.lower()
    if e1=="yes":
        print()
